/// <summary>
/// This class is from https://github.com/azixMcAze/Unity-SerializableDictionary
/// </summary>
...
namespace SideRift.SaveSystem
{
    ...
    internal class SerializableDictionary<TKey, TValue, TValueStorage> : SerializableDictionaryBase<TKey, TValue, TValueStorage> where TValueStorage : SerializableDictionary.Storage<TValue>, new()
    {
        public SerializableDictionary()
        {
        }
